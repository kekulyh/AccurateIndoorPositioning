...
@Controller
public class GestureAndroidController {

	@Autowired
	private DeviceService deviceService;
	
	@RequestMapping(value="/gestureandroid")
	public ModelAndView gesture(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// TODO Auto-generated method stub
		return new ModelAndView("gestureandroid");
	}
	
	@RequestMapping(value="/gestureandroid", method=RequestMethod.POST, produces = "application/json")
