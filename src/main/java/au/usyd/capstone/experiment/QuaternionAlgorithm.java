...
public class QuaternionAlgorithm {
	...
	public static Quaternion calculateQuaternionNineAxis(double accel1, double accel2, double accel3, double gyro1, double gyro2, double gyro3, double mag1, double mag2, double mag3){
		...
		if(!((accel1 == 0.0f) && (accel2 == 0.0f) && (accel3 == 0.0f))) {
			...
			hx = mag1 * q0q0 - _2q0my * q3 + _2q0mz * q2 + mag1 * q1q1 + _2q1 * mag2 * q2 + _2q1 * mag3 * q3 - mag1 * q2q2 - mag1 * q3q3;
			hy = _2q0mx * q3 + mag2 * q0q0 - _2q0mz * q1 + _2q1mx * q2 - mag2 * q1q1 + mag2 * q2q2 + _2q2 * mag3 * q3 - mag2 * q3q3;
			_2bx = Math.sqrt(hx * hx + hy * hy);
			_2bz = -_2q0mx * q2 + _2q0my * q1 + mag3 * q0q0 + _2q1mx * q3 - mag3 * q1q1 + _2q2 * mag2 * q3 - mag3 * q2q2 + mag3 * q3q3;
			_4bx = 2.0f * _2bx;
			_4bz = 2.0f * _2bz;

			// Gradient decent algorithm corrective step
			s0 = -_2q2 * (2.0f * q1q3 - _2q0q2 - accel1) + _2q1 * (2.0f * q0q1 + _2q2q3 - accel2) - _2bz * q2 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mag1) + (-_2bx * q3 + _2bz * q1) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - mag2) + _2bx * q2 * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mag3);
			s1 = _2q3 * (2.0f * q1q3 - _2q0q2 - accel1) + _2q0 * (2.0f * q0q1 + _2q2q3 - accel2) - 4.0f * q1 * (1 - 2.0f * q1q1 - 2.0f * q2q2 - accel3) + _2bz * q3 * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mag1) + (_2bx * q2 + _2bz * q0) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - mag2) + (_2bx * q3 - _4bz * q1) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mag3);
			s2 = -_2q0 * (2.0f * q1q3 - _2q0q2 - accel1) + _2q3 * (2.0f * q0q1 + _2q2q3 - accel2) - 4.0f * q2 * (1 - 2.0f * q1q1 - 2.0f * q2q2 - accel3) + (-_4bx * q2 - _2bz * q0) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mag1) + (_2bx * q1 + _2bz * q3) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - mag2) + (_2bx * q0 - _4bz * q2) * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mag3);
			s3 = _2q1 * (2.0f * q1q3 - _2q0q2 - accel1) + _2q2 * (2.0f * q0q1 + _2q2q3 - accel2) + (-_4bx * q3 + _2bz * q1) * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mag1) + (-_2bx * q0 + _2bz * q2) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - mag2) + _2bx * q1 * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mag3);
			normalizedDenominator = 1 / Math.sqrt(s0 * s0 + s1 * s1 + s2 * s2 + s3 * s3); 
